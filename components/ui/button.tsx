  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        REQUESTED: "bg-[#FFD12E33] text-[#FFD12E]",
        CONFIRMED: "bg-[#1E78FF33] text-[#1E78FF]",
        PAIED: "bg-[#1E78FF33] text-[#1E78FF]",
        SHIPPING: "bg-[#1E78FF33] text-[#1E78FF]",
        DELIVERED: "bg-[#1E78FF33] text-[#1E78FF]",
        CANCELED: "bg-[#1E78FF33] text-[#1E78FF]",
        REFENDED: "bg-[#1E78FF33] text-[#1E78FF]",
        DOCCONFIRMATION: "bg-[#1E78FF33] text-[#1E78FF]",
        subscribed: "bg-[#0582FE12] text-[#1E78FF]",
        notSubscribed: "bg-[#0582FE12] text-[#1E78FF]",

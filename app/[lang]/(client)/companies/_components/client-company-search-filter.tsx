...
function ClientCompanySearchFilter({ dict }: Props) {
  const [searchTerm, setSearchTerm] = useState("");
  const debouncedSearchTerm = useDebounce(searchTerm, 300);

  const { onSearch, companyData } = useFilterModal();
  ...
  return (
    <div className="relative w-full max-w-sm">
      <Input
        ...
        placeholder={dict.general.search}
        type="text"
      />
...
export default ClientCompanySearchFilter;
